...
export class EsStaff {
  ...
  toProfile() {
    return {
      ...
      dob: toSimpleShortDate(this.stDob),
      avatar: this.image,
      email: this.stEmail,
      class: this.stClass,
      gender: this.stGender,
      bloodGroup: this.stBloodgroup,
      education: this.education1,
      regNo: this.hrdsid,
      contact: this.stPemobileno,
      address: this.stPeadress,
      subject: this.stSubject,
      department: this.stDepartment,
    };
  }
}
